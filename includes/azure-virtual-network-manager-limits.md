...
| IP Prefixes | Max 20000 IP prefixes combined per one network manager resources |
| Admin Rules | Max 100 admin rules combined per one network manager resources |
